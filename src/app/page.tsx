  ...
  return (
    <div className="flex h-screen overflow-hidden text-foreground relative">
      ...
      <main className="flex-1 relative overflow-hidden bg-background">
        ...
        <div 
          className={cn(
            "absolute inset-y-0 left-0 z-30 transition-all duration-600 ease-[cubic-bezier(0.19,1,0.22,1)] border-r border-white/5",
        ...
        <div 
          className={cn(
            "absolute inset-y-0 right-0 flex flex-col transition-all duration-600 ease-[cubic-bezier(0.19,1,0.22,1)] z-10",
            isSidebarOpen 
