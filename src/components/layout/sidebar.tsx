...
export default function Sidebar({
  ...
  return (
    <aside className={cn(
      "relative h-full z-40 bg-[#0a0a0a]/98 backdrop-blur-2xl border-r border-white/5 transition-all duration-500 ease-in-out flex flex-col overflow-hidden shrink-0",
      isSidebarOpen ? "w-80 opacity-100" : "w-0 opacity-0 pointer-events-none"
    )}>
      {/* Content wrapper with fixed width to prevent content jumping during width animation */}
